      ...
      <div class="right_col" role="main">
        ...
        <div class="row">
          ...
          <div class="col-xl-3 col-lg-12 col-md-6 col-sm-12 col-12">
            ...
            <!-- ============================================================== -->
            <div class="card">
              <h5 class="card-header">Add Shop Category</h5>
              <div class="card-body p-0">
                <form action="{{route('super-admin.shop-category-save')}}" method="POST" enctype="multipart/form-data" class="p-2">
                  @csrf
                  @if ($errors->any())
                  ...
                  <div class="form-group">
                    <label for="name" class="col-form-label">Shop Category Name</label>
                  ...
                  <table class="table">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td><img src="{{asset('assets/images/shop_category/'.$category->img)}}" height="40" alt=""></td>
                        <td>{{$category->name}}</td>
                      </tr>
                      @endforeach
                    </tbody>
