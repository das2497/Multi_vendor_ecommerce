      ...
      <div class="right_col" role="main">
        ...
        <div class="row">
          ...
          <div class="col-xl-3 col-lg-12 col-md-6 col-sm-12 col-12">
            ...
            <!-- ============================================================== -->
            <div class="card">
              <h5 class="card-header">Add Product Sub Category</h5>
              <div class="card-body p-0">
                <form action="{{route('super-admin.product-sub-category-save')}}" method="POST" enctype="multipart/form-data" class="p-2">
                  @csrf
                  @if ($errors->any())
                  ...
                  <div class="form-group">
                    <label for="m_category" class="col-form-label">Product Main Category Name</label>
                    <select name="main_category" id="m_category" class="form-control">
                  ...
                  <div class="form-group">
                    <label for="name" class="col-form-label">Product Sub Category Name</label>
                    <input name="name" id="name" type="text" class="form-control" placeholder="Product Sub Category Name" value="{{old('name')}}">
                  </div>
                  <div class="form-group">
          ...
          <div class="col-xl-9 col-lg-12 col-md-6 col-sm-12 col-12">
            <div class="card">
              ...
              @endif
              <h5 class="card-header">All Product Sub Categories</h5>
              <div class="card-body p-0">
                  ...
                  <table class="table">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td><img src="{{asset('assets/images/product_sub_category/'.$category->img)}}" height="40" alt=""></td>
