        ...
        <div class="row  w-100" style="display: inline-block;">
          <div class="tile_count">
            ...
            <div class="col-md-2 col-sm-4  tile_stats_count">
              ...
              <div class="count">{{$shops->count()}}</div>
            </div>
            <div class="col-md-2 col-sm-4  tile_stats_count">
              <span class="count_top"><i class="fa fa-user"></i> Total Riders</span>
              <div class="count">{{$riders->count()}}</div>
            </div>
            <div class="col-md-2 col-sm-4  tile_stats_count">
            ...
            <div class="col-md-2 col-sm-4  tile_stats_count green">
              ...
              <div class="count">{{$today_orders->count()}}</div>
              <span class="count_bottom"><i class="green"></i> {{$date}} </span>
            </div>
          </div>
        </div>
        <!-- /top tiles -->
