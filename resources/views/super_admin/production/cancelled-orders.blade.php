                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <ul class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active"><a href="#">Cancelled orders</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><span style="background-color: red; color: white;" class=" p-2 rounded">{{$order->status}}</span></td>
                                                <td>{{$order->rider_name}}</td>
                                                <td>
                                                    <a href="/super-admin/cancelled-orders-view/{{$order->order_id}}" class="btn btn-primary">View</a>
                                                </td>
                                            </tr>
                                            @endforeach
                                        </tbody>
