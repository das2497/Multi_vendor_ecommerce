                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <ul class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active"><a href="#">Shipping orders</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><span style="background-color: orangered; color: white;" class=" p-2 rounded">{{$order->status}}</s></td>
                                                <td>{{$order->rider_name}}</td>
                                                <td>
                                                    <a href="/super-admin/shipping-orders-view/{{$order->order_id}}" class="btn btn-primary">View</a>
                                                </td>
                                            </tr>
                                            @endforeach
                                        </tbody>
