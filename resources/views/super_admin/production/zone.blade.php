        ...
        <div class="row">
          ...
          <div class="col-xl-3 col-lg-12 col-md-6 col-sm-12 col-12">
            ...
            <div class="card">
              ...
              <div class="card-body p-0">
                <form action="{{route('super-admin.zone-save')}}" method="POST" enctype="multipart/form-data" class="p-2">
                  @csrf
                  @if ($errors->any())
                  ...
                  <div class="form-group">
                    <label for="sp_uname" class="col-form-label">Zone Name</label>
                    <input name="name" id="name" type="text" class="form-control" placeholder="Zone Name" value="{{old('name')}}">
                  </div>
                  <div class="form-group">
          ...
          <div class="col-xl-9 col-lg-12 col-md-6 col-sm-12 col-12">
            <div class="card">
              ...
              @endif
              <h5 class="card-header">All Zones</h5>
              <div class="card-body p-0">
