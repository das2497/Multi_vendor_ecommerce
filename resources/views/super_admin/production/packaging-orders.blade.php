                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><span class="bg-warning p-2 rounded">{{$order->status}}</s></td>
                                                <form action="{{route('super-admin.packaging-orders-add-rider')}}" method="POST">
                                                    @csrf
                                                    <td>
                                                        <select name="rider_id" id="rider_id" class="form-control-sm">
                                                            <option value="">Select Rider</option>
                                                            <option value="null">Remove Rider</option>
                                                ...
                                                <td>
                                                    <a href="/super-admin/new-orders-view/{{$order->order_id}}" class="btn btn-primary">View</a>
                                                </td>
                                            </tr>
                                            @endforeach
                                        </tbody>
