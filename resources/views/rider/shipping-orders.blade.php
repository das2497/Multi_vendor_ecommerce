        ...
        <div class="main_container">
            ...
            <div class="right_col" role="main">
                ...
                <div class="container mt-2">
                    <div class="row">
                        <div class="col-lg-12">
                            <h2>Shiping orders</h2>
                            <ul class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{route('rider.dashboard')}}">Dashboard</a></li>
                                <li class="breadcrumb-item active"><a href="#">Shiping orders</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <form action="{{route('rider.shipping-orders-change-state')}}" method="POST">
                                                    @csrf
                                                    <td>
                                                ...
                                                <td>
                                                    <a href="/rider/shipping-orders-view/{{$order->order_id}}" class="btn btn-primary">View</a>
                                                </td>
                                            </tr>
                                            @endforeach
                                        </tbody>
