        ...
        <div class="main_container">
            ...
            <div class="right_col" role="main">
                ...
                <div class="container mt-2">
                    <div class="row">
                        <div class="col-lg-12">
                            <h2>Cancelled orders view</h2>
                            <ul class="breadcrumb">
                                <li class="breadcrumb-item"><a href="/rider/dashboard">Dashboard</a></li>
                                <li class="breadcrumb-item active"><a href="/rider/canceled-orders">Cancelled orders</a></li>
                                <li class="breadcrumb-item active">Cancelled orders view</li>
                            </ul>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="card-header">
                                <div class="row">
                                    <div class="col-4">
                                        ...
                                        <p class="text-muted"> Status : <span style="background-color: red; color: white;" class="p-1 rounded">{{$order->status}}</span></p>
