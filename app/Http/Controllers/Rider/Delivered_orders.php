...
class Delivered_orders extends Controller
{
    public function view()
    {
        ...
        return view('rider.delivered-orders', [
            'orders' => $orders
        ]);
    }

    public function delevered_orders_view(Request $request)
    {
        ...
        return view('rider.delivered-orders-view', [
            'order' => $order,
